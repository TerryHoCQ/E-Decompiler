...
EStaticArchitecture::EStaticArchitecture():IDAArchitecture("x86:LE:32:default")
{
	this->addInjection("alloca_probe", "alloca_probe");
	this->addInjection("guard_dispatch_icall_fptr", "guard_dispatch_icall");
}
