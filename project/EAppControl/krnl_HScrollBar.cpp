...
void krnl_HScrollBar::取控件默认附加属性(QHash<QString, QVariant>& out_data)
{
...
void krnl_HScrollBar::反序列化控件附加属性(unsigned char* pUnitDataPtr, QHash<QString, QVariant>& out_data)
{
	HScrollBar_UnitData tmpData;
...
void krnl_HScrollBar::显示控件属性信息(QHash<QString, QVariant>& map_ControlData)
{
...
qstring krnl_HScrollBar::取事件名称(int eventIndex)
{
	qstring ret;
	switch (eventIndex)
	{
...
QString krnl_HScrollBar::取图标资源路径()
{
	return QStringLiteral(":/ICO/ICO/横向滚动条.ico");
}