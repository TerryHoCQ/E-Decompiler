...
static uint1 myprog[] = {
  0xEB, 0x0E, 0x24, 0x04, 0x83, 0xe4, 0xf0, 0xff, 0x71, 0xfc, 0x55,
...
{ // Dump pcode translation of machine instructions
  ...
  Address addr(trans.getDefaultCodeSpace(),0x401000); // First address to translate
  Address lastaddr(trans.getDefaultCodeSpace(),0x401040); // Last address
...

{
  ...
  MyLoadImage loader(0x401000,myprog,408);
  //  loader->open();
